...
class _MoneyshareUIState extends State<MoneyshareUI> {
  ...
  //สร้างออปเจ็กต์เพื่อนำไปใช้ควมคุม TexyField ในหน้าจอที่สร้างไว้
  TextEditingController money_Ctr1 = TextEditingController();
        ...
        child: Center(
          child: Column(
            children: [
              ...
              ElevatedButton.icon(
                onPressed: () {
                  //เขียน Logic การทำงานโดยจะเคลียค่าทุกอย่างบนหน้าจอกลับมาเป็นเหมือนเดิม
                  setState(() {
                    money_Ctr1.text = '';
                    person_Ctr1.text = '';
                    tip_Ctr1.text = '';
